...
@Component({
  ...
  standalone: true,
  imports: [PagetitleComponent, DragulaModule],
  template: `
    <app-pagetitle
      title="Dragula"
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted font-14">
              ...
              <code>data-plugin='dragula'</code> to have drag and drop support
              in your container.
            </p>
            ...
            >
              ...
              <div class="col-md-4">
                <div
                  class="card mb-0 mt-3 text-white bg-warning text-xs-center"
                >
                  <div class="card-body">
                    <blockquote class="card-bodyquote mb-0">
                      <p>
                          ...
                          <div class="w-100 overflow-hidden">
                            ...
                            <p class="mb-0 text-muted">
                              <span class="fst-italic"
                                ><b>"</b>Disrupt pork belly poutine,
                                asymmetrical tousled succulents selfies. You
                                probably haven't heard of them tattooed master
                                cleanse live-edge keffiyeh.</span
                              >
                            </p>
                          </div>
                          <!-- end w-100 -->
...
export class DragulaComponent {
  constructor(private dragulaService: DragulaService) {
    if (!this.dragulaService.find('HANDLES')) {
