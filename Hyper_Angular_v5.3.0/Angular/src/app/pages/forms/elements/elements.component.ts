          ...
          <div class="card-body">
            ...
            <div class="form-check form-radio-dark">
              <input
                ...
                checked
              />
              <label class="form-check-label" for="customRadiocolor7"
                >Dark Radio</label
              >
            </div>
          </div>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <form>
              <div class="mb-3">
                <label for="example-input-small" class="form-label"
                  >Small</label
                >
                <input
                  type="text"
              ...
              <div class="mb-3">
                <label for="example-input-large" class="form-label"
                  >Large</label
                >
                <input
                  type="text"
              ...
              <div class="mb-2">
                <label for="example-gridsize" class="form-label"
                  >Grid Sizes</label
                >
                <div class="row">
                  <div class="col-sm-4">
          ...
          <div class="card-body">
            ...
            <form>
              ...
              <div class="row g-2">
                ...
                <div class="col-sm-6">
                  <label for="formFileMultiple01" class="form-label"
              ...
              <div class="mb-3">
                <div class="form-check">
                  <input
                    ...
                    id="checkmeout0"
                  />
                  <label class="form-check-label" for="checkmeout0"
                    >Check me out !</label
                  >
                </div>
              </div>
