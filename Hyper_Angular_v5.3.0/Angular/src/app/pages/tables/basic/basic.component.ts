                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="progress progress-sm">
                        <div
                          class="progress-bar progress-lg bg-warning"
                          role="progressbar"
                          style="width: 50%"
                          aria-valuenow="50"
                          aria-valuemin="0"
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="progress progress-sm">
                        <div
                          class="progress-bar progress-lg bg-info"
                          role="progressbar"
                          style="width: 25%"
                          aria-valuenow="25"
                          aria-valuemin="0"
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted font-14">
              ...
              <code>.border-primary</code> can be added to change colors.
            </p>

            <div class="table-responsive-sm">
              <table
                class="table table-bordered border-primary table-centered mb-0"
              >
                <thead>
                  <tr>
                    <th>User</th>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted font-14">
              ...
              Use
              <code>.table-responsive &#0123;-sm|-md|-lg|-xl&#0125;</code> as
