          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="avatar-md">
                  <span
                    class="avatar-title bg-info-lighten text-info font-20 rounded"
                  >
                    MD
                  </span>
                </div>
              ...
              <div class="col-md-3">
                <div class="avatar-xl">
                  <span
                    class="avatar-title bg-warning-lighten text-warning font-24 rounded"
                  >
                    XL
                  </span>
                </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="avatar-xl">
                  <span
                    class="avatar-title bg-primary-lighten text-primary font-24 rounded-circle"
                  >
                    XL
                  </span>
                </div>
