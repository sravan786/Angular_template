          ...
          <div class="card-body">
            ...
            <ul class="list-group">
              <li class="list-group-item">
                <i class="uil-google-drive-alt me-1"></i> Google Drive
              </li>
              <li class="list-group-item">
                <i class="uil-facebook-messenger me-1"></i> Facebook Messenger
              </li>
              <li class="list-group-item">
                <i class="uil-apple me-1"></i> Apple Technology Company
              </li>
              <li class="list-group-item">
                <i class="uil-intercom me-1"></i> Intercom Support System
              </li>
              <li class="list-group-item">
                <i class="uil-paypal me-1"></i> Paypal Payment Gateway
              </li>
            </ul>
          </div>
          <!-- end card-body -->
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted font-14">
              ...
              <code>.list-group-horizontal-#&0123;sm|md|lg|xl#&0125;</code> to
              make a list group horizontal starting at that breakpoint’s
              <code>min-width</code>.
            </p>
